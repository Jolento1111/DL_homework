...
def main(args):
    ...
    # logging
    log_file = f"log/lr{args.lr}_eps{args.epochs}_{args.batch_size}.log"
    ...
    for epoch in range(args.epochs):
        ...
        for val_imgs, val_labels in valid_loader:
            ...
            loss = criterion(val_logits, val_labels.cuda().to(torch.int64))
...
if __name__ == '__main__':
    ...
    # Run three experiments with lr=0.5, 0.05, and 0.01 respectively
    for lr in [0.5, 0.05, 0.01]:
        args.lr = lr
        args.fig_name = f"lr_{lr}_experiment.png"
